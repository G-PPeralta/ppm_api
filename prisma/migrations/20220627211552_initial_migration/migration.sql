...
-- CreateIndex
CREATE UNIQUE INDEX "tb_proj_ativ_predecessor_atividade_id_key" ON "tb_proj_ativ_predecessor"("atividade_id");

-- CreateIndex
CREATE UNIQUE INDEX "tb_proj_ativ_predecessor_predecessor_id_key" ON "tb_proj_ativ_predecessor"("predecessor_id");
